...
exports.default = [
    {
        request: function (req) { return req.contactId == '999999'; },
        response: {
            status: 400
        }
    },
    {
        request: function (req) { return req.contactId == '888888'; },
        response: {
            status: 404
        }
    },
    {
        request: function (req) { return req.contactId == '777777'; },
        response: {
            status: 500
        }
    },
...
//# sourceMappingURL=getPaymentCardList.js.map