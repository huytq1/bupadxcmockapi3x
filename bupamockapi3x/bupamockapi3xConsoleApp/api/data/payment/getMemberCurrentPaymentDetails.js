...
exports.default = [
    ...
    // Nhung Nguyen UC100 AC07 Cheque has no pending
    {
        ...
        response: {
            data: {
                membershipId: 3743028,
                contributor: "Shukla Dehar Charmsaz",
                customerType: "Gold",
                directDebitDetail: {
                    membershipId: 3743028,
                    datePaidTo: '2014-10-05T00:00:00.000Z',
    ...
    // Nhung Nguyen UC100 AC07 cash has no pending
    {
        ...
        response: {
            data: {
                membershipId: 4004073,
                contributor: "Maika Dehar Astarci",
                customerType: "Gold",
                directDebitDetail: {
                    membershipId: 4004073,
                    datePaidTo: '2014-10-05T00:00:00.000Z',
        ...
        response: {
            data: {
                ...
                refundPaymentInfo: {
                    ...
                    refundAmount: 120,
                    paymentType: "Bank Account",
                    paymentDetails: "Nothing - 123456 - 6789012340",
                    adjustedBalance: 1543.646496,
                    paymentCardId: 0,
                    _links: {}
                },
                ...
                lastProcessedPaymentDetail: {
                    ...
                    paymentMethod: "OSHC",
                    paymentDetails: "ABCD - 123456 - 6789012340",
                    isWithinDishonourPeriod: true
                }
            }
        }
        ...
        response: {
            data: {
                ...
                directDebitDetail: {
                    ...
                    deactivatedDate: "2017-09-26T00:00:00.000Z",
                    _links: {}
                },
                pendingSinglePayment: {
                    membershipId: 98111111,
        ...
        response: {
            data: {
                ...
                directDebitDetail: {
                    ...
                    deactivatedReason: "Too late",
                    reactivationDate: "2017-09-10T00:00:00.000Z",
                    paymentCardId: 1,
                    rateSummary: {
                        "rebateAmount": 111,
                        "rebatePercent": 24.2225,
                    ...
                    deactivatedDate: "2017-08-15T00:00:00.000Z",
                    _links: {}
                },
                pendingSinglePayment: {
                    membershipId: 98111112,
        ...
        response: {
            data: {
                ...
                directDebitDetail: {
                    ...
                    paymentCardExpiry: "2017-09-15T00:00:00.000Z",
                    deactivatedReason: "Too late",
                    reactivationDate: "2017-09-26T00:00:00.000Z",
                    paymentCardId: 1,
                    rateSummary: {
                        "rebateAmount": 111,
                        "rebatePercent": 24.2225,
        ...
        response: {
            data: {
                ...
                directDebitDetail: {
                    ...
                    paymentCardExpiry: "2016-09-15T00:00:00.000Z",
                    deactivatedReason: "Too late",
                    reactivationDate: "2016-12-30T00:00:00.000Z",
                    paymentCardId: 1,
                    rateSummary: {
                        "rebateAmount": 1.014,
                    ...
                    deactivatedDate: "2018-10-30T00:00:00.000Z",
                    _links: {}
                },
                pendingSinglePayment: {
                    membershipId: 35790009,
...
//# sourceMappingURL=getMemberCurrentPaymentDetails.js.map