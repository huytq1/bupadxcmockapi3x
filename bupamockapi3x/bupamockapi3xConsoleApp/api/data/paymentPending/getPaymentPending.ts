export default [
    ...
    {
        request: req => req.membershipId == '888888',
        response: {
            status: 401,
    ...
    { //Tung Nguyen -119385: UC0222C_AC08_ST002
        request: req => req.membershipId == '202234',
        response: {
            status: 401,
            data: "Authentication to use this service is required and has failed or has not yet been provided. Please try again and contact the Bupa IS Service Desk if the issue persists. (error 401 - unauthorised)"
        }
    ...
    {
        request: req => req.membershipId == '666666',
        response: {
            status: 404,
    ...
    {
        request: req => req.membershipId == '400400',
        response: {
            status: 400,
            data: "The requested resource could not be found. (error 404 - not found)"
        }
    ...
    {
        request: req => req.membershipId == '555555',
        response: {
            status: 500,
    ...
    {
        request: req => req.membershipId == '444444',
        response: {
            status: 500,
            data: "We are sorry - an internal server error has occured. Please try again and contact the Bupa IS Service Desk if the issue persists. (error 500 - internal server error)"
        }
	...
	*/
    ...
    {   // Test case 119388: UC0222C_AC08_ST005
        request: req => req.membershipId == '20641231',
        response: {
            status: 406,
            data: "We are sorry - something went wrong with the request sent to the service. Please try again and contact the Bupa IS Service Desk if the issue persists. (error 406 - not acceptable)"
        }
    },
    {   // Test case 119389: UC0222C_AC08_ST006
        request: req => req.membershipId == '20261768',
        response: {
            status: 500,
            data: "We are sorry - an internal server error has occured. Please try again and contact the Bupa IS Service Desk if the issue persists. (error 500 - internal server error)"
        }
    ...
    {
        request: req => req.membershipId == '159210',
        response: {
            status: 404,
            data: "The requested resource could not be found. (error 404 - not found)"
        }
    },
    {	// Test case 106850: UC0222C_AC01_ST001;    108803: UC0222C_AC03_ST002;     119374: UC0222C_AC06_ST005;     119370: UC0222C_AC06_ST001
        request: {
    ...
    {	// Test case 114583: UC0222C_AC04_ST004
        request: {
        ...
        response: {
            data: [
                ...
                {// Vuong Chon 114583: UC0222C_AC04_ST004
                    membershipId: 44512786,
                    transactionId: 3,
                    requestedDate: "2016-12-27T00:00:00",
                    paymentDate: "2016-09-15T00:00:00",
    ...
    {	// Test case 119383: UC0222C_AC07_ST002
        request: {
    ...
    {	// Test TC 106891 UC0222C_AC03_ST001
        request: {
    ...
    {	//Tung Nguyen // Test case 119369: UC0222C_AC05_ST003 ,has some Pending Payment Transaction List
    ...
    {	//Tung Nguyen - 119382-UC0222C_AC07_ST001
        request: {
    ...
    {	// Test TC 108804 UC0222C_AC04_ST001
        request: {
    ...
    {	// Test TC 114581 UC0222C_AC04_ST002
        request: {
    ...
    {	//Test Case 119379: UC0222C_AC06_ST010
        request: {
    ...
    { // Test case 107643 UC0101Cv2_AC01_ST001
        request: {
    ...
    {	// Test TC 119371 UC0222C_AC06_ST002; // Chon Vuong Test case UC0222C_AC02_ST002 119371
        request: {
    ...
    { // Test case 107647 UC0101Cv2_AC02_ST001
        request: {
    ...
    { // Test case 134783: UC0098Cv34_AC11_ST002
        request: {
            membershipId: 922004
        },
        response: {
    ...
    { // Test case 134785: UC0098Cv34_AC11_ST004
        request: {
            membershipId: 922006
        },
        response: {
    ...
    {  // Test case 107655 UC0101Cv2;      134782: UC0098Cv34_AC11_ST001
        request: {
    ...
    { // Chon Vuong - Test Case 108804: UC0222C_AC04_ST001
        request: {
